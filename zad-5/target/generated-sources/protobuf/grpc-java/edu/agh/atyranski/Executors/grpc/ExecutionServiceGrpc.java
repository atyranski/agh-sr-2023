...
public final class ExecutionServiceGrpc {
  ...
  public static final String SERVICE_NAME = "edu.agh.atyranski.Executors.grpc.ExecutionService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<edu.agh.atyranski.Executors.grpc.ExecutionRequest,
      edu.agh.atyranski.Executors.grpc.ExecutionResponse> getExecuteMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "execute",
      requestType = edu.agh.atyranski.Executors.grpc.ExecutionRequest.class,
      responseType = edu.agh.atyranski.Executors.grpc.ExecutionResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<edu.agh.atyranski.Executors.grpc.ExecutionRequest,
      edu.agh.atyranski.Executors.grpc.ExecutionResponse> getExecuteMethod() {
    io.grpc.MethodDescriptor<edu.agh.atyranski.Executors.grpc.ExecutionRequest, edu.agh.atyranski.Executors.grpc.ExecutionResponse> getExecuteMethod;
      ...
      synchronized (ExecutionServiceGrpc.class) {
        if ((getExecuteMethod = ExecutionServiceGrpc.getExecuteMethod) == null) {
          ExecutionServiceGrpc.getExecuteMethod = getExecuteMethod =
              io.grpc.MethodDescriptor.<edu.agh.atyranski.Executors.grpc.ExecutionRequest, edu.agh.atyranski.Executors.grpc.ExecutionResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "execute"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.agh.atyranski.Executors.grpc.ExecutionRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  edu.agh.atyranski.Executors.grpc.ExecutionResponse.getDefaultInstance()))
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                edu.agh.atyranski.Executors.grpc.ExecutionRequest,
                edu.agh.atyranski.Executors.grpc.ExecutionResponse>(
  ...
  public static final class ExecutionServiceBlockingStub extends io.grpc.stub.AbstractStub<ExecutionServiceBlockingStub> {
     ...
     * </pre>
     */
    public edu.agh.atyranski.Executors.grpc.ExecutionResponse execute(edu.agh.atyranski.Executors.grpc.ExecutionRequest request) {
  ...
  public static final class ExecutionServiceFutureStub extends io.grpc.stub.AbstractStub<ExecutionServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<edu.agh.atyranski.Executors.grpc.ExecutionResponse> execute(
        edu.agh.atyranski.Executors.grpc.ExecutionRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXECUTE:
          serviceImpl.execute((edu.agh.atyranski.Executors.grpc.ExecutionRequest) request,
              (io.grpc.stub.StreamObserver<edu.agh.atyranski.Executors.grpc.ExecutionResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ExecutionServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return edu.agh.atyranski.Executors.grpc.ExecutorService.getDescriptor();
    }

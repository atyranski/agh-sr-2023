...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return showHelp(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String showHelp(java.util.Map<String, String> context)
    {
        return _iceI_showHelpAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> showHelpAsync()
    {
        return _iceI_showHelpAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> showHelpAsync(java.util.Map<String, String> context)
    {
        return _iceI_showHelpAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_showHelpAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "showHelp", null, sync, null);
